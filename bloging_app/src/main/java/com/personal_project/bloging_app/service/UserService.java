...
//	public ResponseEntity<ResponseStructure<List<User>>> deleteAll() {
//        List<User> deletedUsers = userdao.getAllUsers();
//        ResponseStructure<List<User>> structure = new ResponseStructure<>();
//  if (deletedUsers!=null) {
//	
//}      
//        structure.setStatus(HttpStatus.OK.value());
//		 structure.setData(deletedUsers);
//        structure.setMessage("All users deleted successfully");
//        structure.setData(deletedUsers);
//
...
//
//	{
//		throw new com.personal_project.bloging_app.exception.IdNotFoundException("User Not found");
//	}
